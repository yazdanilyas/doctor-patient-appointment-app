...
import com.cybereast.modernqueue.databinding.FragmentPrescriptionHistoryBinding
...
class PrescriptionHistoryFragment : Fragment() {
    ...
    private lateinit var mBinding: FragmentPrescriptionHistoryBinding
    ...
    override fun onCreateView(
        ...
        mBinding = FragmentPrescriptionHistoryBinding.inflate(inflater, container, false)
        getBundleData()
    ...
    companion object {
        ...
        fun newInstance(mBundle: Bundle) = PrescriptionHistoryFragment().apply {
            arguments = mBundle
        }
    }
}